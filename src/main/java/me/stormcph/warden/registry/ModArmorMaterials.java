...
public enum ModArmorMaterials implements ArmorMaterial {
    WARDEN("warden", 5000, new int[]{4, 7, 9, 4}, 16,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 4.0F, 0.1F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{ModItems.WARDEN_INGOT});
    });
